            ...
            <div className="flex flex-col gap-8">
              ...
              <div className={`rounded-lg border p-5 ${
                ...
                <div className="flex items-end justify-center gap-8 flex-wrap">
                  ...
                  {/* Claude Code */}
                  <div className="flex flex-col items-center gap-1.5" title="Claude Code">
                    <svg
                  ...
                  {/* Factory Droid */}
                  <div className="flex flex-col items-center gap-1.5" title="Factory Droid">
                    <svg
                  ...
                  {/* Cursor - Coming Soon */}
                  <div className="flex flex-col items-center gap-1.5 relative" title="Cursor (Coming Soon)">
                    <span className={`absolute -top-5 text-[8px] px-1.5 py-0.5 rounded whitespace-nowrap ${
                      isDark ? "bg-zinc-800 text-zinc-500" : "bg-[#ebe9e6] text-[#8b7355]"
                    }`}>
                      coming soon
                    </span>
                    <svg
                    ...
                    <span className={`text-[10px] ${isDark ? "text-zinc-600" : "text-[#8b7355]"}`}>
                      Cursor
                    </span>
                  </div>
                </div>
